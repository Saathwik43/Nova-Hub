      ...
      <section className="py-24 max-w-6xl mx-auto px-8 relative z-10">
        <div className="mb-12 max-w-2xl">
          <h2 className="text-4xl md:text-5xl font-display italic font-bold text-[#1a1a1a] mb-6">
            A glimpse of local tournaments
          </h2>
          <p className="text-[10px] md:text-xs font-mono text-[#1a1a1a]/70 leading-relaxed uppercase tracking-widest">
            Teaming up with organizers to get fuzzy weekend games to professional leagues - we design the bracket clarity that gets you there.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-24">
          ...
          {/* Card 1 */}
          <div onClick={() => navigate('/tournament/cricket')} className="border border-[#1a1a1a]/20 rounded-[2rem] p-6 relative flex flex-col justify-end h-80 md:h-96 overflow-hidden group hover:border-[#1a1a1a]/40 transition-colors cursor-pointer cursor-pointer">
          ...
          {/* Card 2 */}
          <div onClick={() => navigate('/tournament/football')} className="border border-[#1a1a1a]/20 rounded-[2rem] p-6 relative flex flex-col justify-end h-80 md:h-96 overflow-hidden group hover:border-[#1a1a1a]/40 transition-colors cursor-pointer cursor-pointer">
            <div className="absolute inset-0 top-0 left-0 right-0 bottom-16 flex items-center justify-center pointer-events-none">
          ...
          {/* Card 3 */}
          <div onClick={() => navigate('/tournament/badminton')} className="border border-[#1a1a1a]/20 rounded-[2rem] p-6 relative flex flex-col justify-end h-80 md:h-96 overflow-hidden group hover:border-[#1a1a1a]/40 transition-colors cursor-pointer cursor-pointer">
            <div className="absolute inset-0 top-0 left-0 right-0 bottom-16 flex items-center justify-center pointer-events-none">
          ...
          {/* Card 4 */}
          <div onClick={() => navigate('/tournament/hoops')} className="border border-[#1a1a1a]/20 rounded-[2rem] p-6 relative flex flex-col justify-end h-80 md:h-96 overflow-hidden group hover:border-[#1a1a1a]/40 transition-colors cursor-pointer cursor-pointer">
            <div className="absolute inset-0 top-0 left-0 right-0 bottom-16 flex items-center justify-center pointer-events-none">
